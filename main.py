...
if __name__ == '__main__':
    ...
    parser.add_argument("--split", type=str, default=None)        # val / test
    parser.add_argument("--split_json", type=str, default=None)   # path to split file
